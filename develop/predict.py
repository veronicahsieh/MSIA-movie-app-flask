...
def movie_pred(user_frame):
    ...
    Returns:
        Predicted movie revenue value. Value is displayed on the results page of application.
...
def build_pred_frame(genre_code,year,runtime,popularity,rating,budget):
    ...
    Args:
        genre_code: code of the movie genre selected by the user. Code for a movie genre is extracted by a dictionary which maps a movie genre to its corresponding code.
        year: release year entered by the user.
        runtime: runtime of movie entered by the user.
        popularity: popularity of movie entered by the user.
        rating: rating of movie entered by the user.
        budget: budget of movie entered by the user.

    Returns:
        Dataframe used to make movie revenue prediction. Serves as input parameter in movie_pred(user_frame) function.

    """
    col_names = ['budget','runtime','vote_average','release_timespan','popularity_scaled',' 10402',' 10749',' 10751',' 10752',' 10769',' 10770',' 12',' 14',' 16',' 18',' 27',' 28',' 35',' 36',' 37',' 53',' 80',' 878',' 9648',' 99']
