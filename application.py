...
def inputdata():
    if request.method == 'POST':
        ...
        movie_entry = Movie(genre=request.form['genre'], year=request.form['release_year'], runtime=request.form['runtime'], popularity=request.form['popularity'], rating=request.form['rating'], budget=request.form['budget'])
